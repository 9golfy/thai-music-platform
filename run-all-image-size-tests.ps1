# PowerShell script to run all image size warning tests

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  Image Size Warning Tests" -ForegroundColor Cyan
...
Write-Host "4. ⚠️  Warning modal should appear" -ForegroundColor Yellow
...
Write-Host "7. ✅ Modal should not appear again (10 MB total)" -ForegroundColor Green
Write-Host ""
...
# Run regist100 test
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  Running regist100 Image Size Test" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  Running regist-support Image Size Test" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
