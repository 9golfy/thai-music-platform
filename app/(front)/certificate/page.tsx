...
const sections = [
  ...
  },
  {
    ...
    tone: "light" as const,
    intro:
      "คะแนนรวมจากทั้ง ๒ ส่วนจะถูกนำมาพิจารณาเพื่อจัดระดับคุณภาพของสถานศึกษา โดยสถานศึกษาที่ผ่านเกณฑ์ในระดับที่กำหนด จะได้รับใบประกาศนียบัตรเพื่อเชิดชูเกียรติ",
    pills: levels,
  },
  {
    number: "๔",
          ...
          >
            ...
            >
              ...
              <div className="mt-8 space-y-5 text-base leading-8 text-white/82">
                <p>
                  โครงการโรงเรียนดนตรีไทย ๑๐๐ เปอร์เซ็นต์ ประจำปีงบประมาณ พ.ศ. ๒๕๖๙ จัดขึ้นโดยกรมส่งเสริมวัฒนธรรม กระทรวงวัฒนธรรม โดยมีวัตถุประสงค์เพื่อส่งเสริม สนับสนุน และยกระดับการเรียนการสอนดนตรีไทยในสถานศึกษา ตลอดจนปลูกฝังให้เยาวชนไทยมีความรู้ ความสามารถ และความภาคภูมิใจในมรดกทางวัฒนธรรมของชาติ
                </p>
                <p>
