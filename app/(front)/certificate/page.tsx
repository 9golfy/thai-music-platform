...
const sections = [
  {
    ...
    tone: "light" as const,
    intro:
      "การประเมินส่วนนี้มีคะแนนเต็ม 100 คะแนน โดยพิจารณาจากองค์ประกอบหลัก 5 ด้าน ซึ่งสะท้อนความพร้อมและคุณภาพของสถานศึกษาอย่างเป็นระบบ",
  ...
  },
  {
    ...
    tone: "dark" as const,
    intro:
      "การประเมินสื่อผลงานมีคะแนนเต็ม 100 คะแนน โดยพิจารณาจากภาพถ่ายและคลิปวิดีโอที่สะท้อนให้เห็นถึงการดำเนินงานจริงของสถานศึกษา ทั้งในมิติของบรรยากาศการเรียนรู้และศักยภาพของผู้เรียน",
    list: mediaCriteria,
  },
  {
    number: "3",
        ...
        <section className="relative isolate">
          ...
          <div className="relative mx-auto grid min-h-[calc(100vh-4rem)] max-w-7xl items-center gap-10 px-4 py-14 sm:px-6 lg:grid-cols-[0.96fr_1.04fr] lg:px-8 lg:py-20">
            ...
            >
              ...
              >
                แนวทางการประเมินที่เป็นระบบ เพื่อรับรองคุณภาพของสถานศึกษาที่ส่งเสริมการเรียนการสอนดนตรีไทยอย่างต่อเนื่องและเป็นรูปธรรม
              </motion.p>
            </motion.div>
