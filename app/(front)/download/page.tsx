...
const downloadFiles = [
  {
    title: 'ประกาศกรมส่งเสริมวัฒนธรรม เรื่องผลการคัดเลือกโรงเรียนดนตรีไทย 100 เปอร์เซ็นต์ ประจำปีงบประมาณ พ.ศ.2569',
    description: 'คลิกดาวน์โหลด ประกาศกรมส่งเสริมวัฒนธรรม เรื่องการคัดเลือกโรงเรียนดนตรีไทย 100 เปอร์เซ็นต์ ประจำปีงบประมาณ พ.ศ.2569',
    url: '/filedownload/file003_ประกาศผลการคัดเลือกดนตรีไทย 2569.pdf',
    type: 'pdf'
  },
  {
  ...
  },
  {
    ...
    description: 'คลิกดาวน์โหลด คู่มือการลงทะเบียนผ่านหน้าเว็บไซต์สำหรับโรงเรียนดนตรีไทย 100 เปอร์เซ็นต์ เวอร์ชัน 1.0',
  ...
  },
  {
    ...
    description: 'คลิกดาวน์โหลด คู่มือการลงทะเบียนผ่านหน้าเว็บไซต์สำหรับโรงเรียนสนับสนุนและส่งเสริมดนตรีไทย เวอร์ชัน 1.0',
  ...
  
  {
    ...
    description: 'คลิกดาวน์โหลด เอกสารหลักเกณฑ์และคุณสมบัติการสมัครเข้าร่วมกิจกรรม',
