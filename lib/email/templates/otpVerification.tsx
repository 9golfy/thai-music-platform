...
export function generateOTPVerificationEmailText(props: OTPVerificationEmailProps): string {
  ...
  return `
กิจกรรมโรงเรียนดนตรีไทย 100 เปอร์เซ็นต์ - รหัส OTP สำหรับเข้าถึงแบบฟอร์มของคุณ
...
export function getOTPVerificationEmailSubject(): string {
  return 'รหัส OTP สำหรับเข้าถึงแบบฟอร์มของคุณ - กิจกรรมโรงเรียนดนตรีไทย 100 เปอร์เซ็นต์';
}
