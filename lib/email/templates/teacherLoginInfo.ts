      ...
      <div class="container">
        ...
        <div class="content">
          <div class="welcome-section">
            <h2>ยินดีต้อนรับสู่ระบบกิจกรรมโรงเรียนดนตรีไทย 100 เปอร์เซ็นต์</h2>
        ...
        <div class="footer">
          ...
          <p>© 2569 กระทรวงวัฒนธรรม. สงวนลิขสิทธิ์.</p>
...
export function generateTeacherLoginInfoEmailText(data: TeacherLoginInfoData): string {
  ...
  return `
กิจกรรมโรงเรียนดนตรีไทย 100 เปอร์เซ็นต์ - ข้อมูลการเข้าสู่ระบบสำหรับคุณครู

ยินดีต้อนรับสู่ระบบกิจกรรมโรงเรียนดนตรีไทย 100 เปอร์เซ็นต์
...
export function getTeacherLoginInfoEmailSubject(schoolName: string): string {
  return `🎵 ข้อมูลการเข้าสู่ระบบ - ${schoolName} | กิจกรรมโรงเรียนดนตรีไทย 100 เปอร์เซ็นต์`;
}