          ...
          {prFields.length === 0 && (
            <div className="border border-neutral-border rounded-lg p-4 space-y-3">
              <div>
                ...
                <input
                  {...register(`reg100_prActivities.0.activityName`)}
                  type="text"
              ...
              <div>
                ...
                <input
                  {...register(`reg100_prActivities.0.platform`)}
                  type="text"
              ...
              <div>
                ...
                <input
                  {...register(`reg100_prActivities.0.publishDate`)}
                  type="text"
              ...
              <div>
                ...
                <input
                  {...register(`reg100_prActivities.0.evidenceLink`)}
                  type="url"
                  placeholder="https://..."
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
      ...
      <div className="bg-white rounded-lg shadow-sm border border-neutral-border overflow-hidden">
        ...
        <div className="p-6">
          <label className="flex items-start gap-3 cursor-pointer">
            <input
              {...register('reg100_certifiedINFOByAdminName')}
              type="checkbox"
            ...
            <div>
              ...
              {errors.reg100_certifiedINFOByAdminName && (
                <p className="text-red-500 text-sm mt-1">{errors.reg100_certifiedINFOByAdminName.message}</p>
              )}
            </div>
          </label>
        </div>
