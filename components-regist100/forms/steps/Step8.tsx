  ...
  useEffect(() => {
    if (!isInitialized.current) {
      if (internalFields.length === 0) {
        appendInternal({ activityName: '', activityDate: '', evidenceLink: '' });
      }
      if (externalFields.length === 0) {
        appendExternal({ activityName: '', activityDate: '', evidenceLink: '' });
      }
      if (outsideFields.length === 0) {
        appendOutside({ activityName: '', activityDate: '', evidenceLink: '' });
      }
