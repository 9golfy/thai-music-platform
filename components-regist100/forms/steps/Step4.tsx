...
function EducationFields({ 
  ...
  teacherIndex: number; 
  type: 'music' | 'other';
  control: Control<Register100FormData>;
  register: UseFormReturn<Register100FormData>['register'];
}) {
  const fieldName = type === 'music' 
    ? `reg100_thaiMusicTeachers.${teacherIndex}.musicInstituteEducation` as const
    : `reg100_thaiMusicTeachers.${teacherIndex}.otherEducation` as const;
            ...
            <div key={field.id} className="border border-neutral-border rounded-lg p-4 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  name={`reg100_thaiMusicTeachers.${index}.teacherImage`}
                  type="file"
              ...
              <div>
                ...
                <textarea
                  {...register(`reg100_thaiMusicTeachers.${index}.teacherAbility`)}
                  rows={3}
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-900 mb-2">
                  <input
                    {...register(`reg100_thaiMusicTeachers.${index}.isFromMusicInstitute`)}
                    type="radio"
                    value="true"
                    className="mr-2"
                  />
                ...
                {form.watch(`reg100_thaiMusicTeachers.${index}.isFromMusicInstitute`) === 'true' && (
              ...
              <div>
                ...
                {/* ✅ แสดง EducationFields เฉพาะเมื่อเลือก radio button แล้ว */}
                {form.watch(`reg100_thaiMusicTeachers.${index}.isFromMusicInstitute`) === 'false' && (
