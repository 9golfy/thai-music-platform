...
export default function Step4({ form, teacherImageFiles, setTeacherImageFiles, mgtImageFile }: Step4Props) {
  ...
  const { 
    ...
    control,
    name: 'reg100_inClassInstructionDurations',
  });
  ...
  const { 
    ...
    control,
    name: 'reg100_outOfClassInstructionDurations',
  });
  ...
  const removeTeacherImage = (index: number) => {
    ...
    const fileInput = document.querySelector(`input[name="reg100_thaiMusicTeachers.${index}.teacherImage"]`) as HTMLInputElement;
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-neutral-border overflow-hidden">
        <div className="bg-green-50 px-6 py-3 border-b border-neutral-border">
          ...
          <p className="text-sm text-gray-600 mt-1">กรุณาเพิ่มอย่างน้อย 1 คน</p>
        </div>
            ...
            <div className="border border-neutral-border rounded-lg p-4 space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-900 mb-1">
                  คุณลักษณะครูผู้สอน <span className="text-red-500">*</span>
                </label>
                <select
                  {...register(`reg100_thaiMusicTeachers.0.teacherQualification`)}
              ...
              <div>
                ...
                <input
                  {...register(`reg100_thaiMusicTeachers.0.teacherFullName`)}
                  type="text"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
              </div>
              ...
              <div>
                ...
                <input
                  {...register(`reg100_thaiMusicTeachers.0.teacherPosition`)}
                  type="text"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
              </div>
              ...
              <div>
                ...
                <input
                  {...register(`reg100_thaiMusicTeachers.0.teacherEducation`)}
                  type="text"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
              </div>
              ...
              <div>
                ...
                <input
                  {...register(`reg100_thaiMusicTeachers.0.teacherPhone`)}
                  type="tel"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
              </div>
              ...
              <div>
                ...
                <input
                  {...register(`reg100_thaiMusicTeachers.0.teacherEmail`)}
                  type="email"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
              </div>
          ...
          {fields.map((field, index) => (
            <div key={field.id} className="border border-neutral-border rounded-lg p-4 space-y-4">
              ...
              <div>
                ...
                <select
                  {...register(`reg100_thaiMusicTeachers.${index}.teacherQualification`)}
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                >
                  <option value="">เลือกคุณลักษณะ</option>
                  <option value="ครูผู้สอนดนตรีในโรงเรียนที่สำเร็จการศึกษาสาขาวิชาดนตรีไทย">
              ...
              <div>
                ...
                <input
                  {...register(`reg100_thaiMusicTeachers.${index}.teacherFullName`)}
                  type="text"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
              </div>
              ...
              <div>
                ...
                <input
                  {...register(`reg100_thaiMusicTeachers.${index}.teacherPosition`)}
                  type="text"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
              </div>
              ...
              <div>
                ...
                <input
                  {...register(`reg100_thaiMusicTeachers.${index}.teacherEducation`)}
                  type="text"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
              </div>
              ...
              <div>
                ...
                <input
                  {...register(`reg100_thaiMusicTeachers.${index}.teacherPhone`)}
                  type="tel"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
              </div>
              ...
              <div>
                ...
                <input
                  {...register(`reg100_thaiMusicTeachers.${index}.teacherEmail`)}
                  type="email"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
            ...
            <div className="border border-neutral-border rounded-lg p-4 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    {...register(`reg100_inClassInstructionDurations.0.inClassGradeLevel`)}
                    type="text"
                    className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                  />
                </div>
                <div>
                  ...
                  <input
                    {...register(`reg100_inClassInstructionDurations.0.inClassStudentCount`)}
                    type="number"
                    min="0"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    {...register(`reg100_inClassInstructionDurations.0.inClassHoursPerSemester`)}
                    type="number"
                    min="0"
                ...
                <div>
                  ...
                  <input
                    {...register(`reg100_inClassInstructionDurations.0.inClassHoursPerYear`)}
                    type="number"
                    min="0"
            ...
            <div key={field.id} className="border border-neutral-border rounded-lg p-4 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-900 mb-1">ระดับชั้น</label>
                  <input
                    {...register(`reg100_inClassInstructionDurations.${index}.inClassGradeLevel`)}
                    type="text"
                    className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-900 mb-1">เรียนดนตรีไทยจำนวน (คน)</label>
                  <input
                    {...register(`reg100_inClassInstructionDurations.${index}.inClassStudentCount`)}
                    type="number"
                    min="0"
                    placeholder='จำนวนนักเรียน (คน)'
                    className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-900 mb-1">ชั่วโมง/ภาคการศึกษา</label>
                  <input
                    {...register(`reg100_inClassInstructionDurations.${index}.inClassHoursPerSemester`)}
                    type="number"
                    min="0"
                    placeholder='จำนวน (ชั่วโมง/ภาคการศึกษา)'
                    className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-900 mb-1">ชั่วโมง/ปีการศึกษา</label>
                  <input
                    {...register(`reg100_inClassInstructionDurations.${index}.inClassHoursPerYear`)}
                    type="number"
                    min="0"
                    placeholder='จำนวน (ชั่วโมง/ปีการศึกษา)'
                    className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
            ...
            <div className="border border-neutral-border rounded-lg p-4 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    {...register(`reg100_outOfClassInstructionDurations.0.outDay`)}
                    className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                  >
                ...
                <div>
                  ...
                  <input
                    {...register(`reg100_outOfClassInstructionDurations.0.outTimeFrom`)}
                    type="text"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    {...register(`reg100_outOfClassInstructionDurations.0.outTimeTo`)}
                    type="text"
                ...
                <div>
                  ...
                  <input
                    {...register(`reg100_outOfClassInstructionDurations.0.outLocation`)}
                    type="text"
                    className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                  />
                </div>
            ...
            <div key={field.id} className="border border-neutral-border rounded-lg p-4 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-900 mb-1">วัน</label>
                  <select
                    {...register(`reg100_outOfClassInstructionDurations.${index}.outDay`)}
                    className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                  >
                    <option value="">เลือกวัน</option>
                    <option value="จันทร์">จันทร์</option>
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-900 mb-1">เวลา</label>
                  <input
                    {...register(`reg100_outOfClassInstructionDurations.${index}.outTimeFrom`)}
                    type="text"
                    placeholder="เช่น 08:00"
                    className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                  />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-gray-900 mb-1">ถึง</label>
                  <input
                    {...register(`reg100_outOfClassInstructionDurations.${index}.outTimeTo`)}
                    type="text"
                    placeholder="เช่น 16:00"
                    className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                  />
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-900 mb-1">สถานที่</label>
                  <input
                    {...register(`reg100_outOfClassInstructionDurations.${index}.outLocation`)}
                    type="text"
                    className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                  />
                </div>
