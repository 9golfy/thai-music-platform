            ...
            {internalFields.length === 0 && (
              <div className="border border-neutral-border rounded-lg p-4 space-y-3">
                <div>
                  ...
                  <input
                    {...register(`reg100_activitiesWithinProvinceInternal.0.activityName`)}
                    type="text"
                ...
                <div>
                  ...
                  <input
                    {...register(`reg100_activitiesWithinProvinceInternal.0.activityDate`)}
                    type="text"
                ...
                <div>
                  ...
                  <input
                    {...register(`reg100_activitiesWithinProvinceInternal.0.evidenceLink`)}
                    type="url"
            ...
            {internalFields.map((field, index) => (
              <div key={field.id} className="border border-neutral-border rounded-lg p-4 space-y-3">
                ...
                <div>
                  ...
                  <input
                    {...register(`reg100_activitiesWithinProvinceInternal.${index}.activityName`)}
                    type="text"
                    className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    {...register(`reg100_activitiesWithinProvinceInternal.${index}.activityDate`)}
                    type="text"
                    placeholder="เช่น 15/05/2568"
                    className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                  />
                ...
                <div>
                  ...
                  <input
                    {...register(`reg100_activitiesWithinProvinceInternal.${index}.evidenceLink`)}
                    type="url"
                    className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                  />
                </div>
            ...
            {externalFields.length === 0 && (
              <div className="border border-neutral-border rounded-lg p-4 space-y-3">
                <div>
                  ...
                  <input
                    {...register(`reg100_activitiesWithinProvinceExternal.0.activityName`)}
                    type="text"
                    placeholder="ชื่อกิจกรรม"
                    className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                  />
                ...
                <div>
                  ...
                  <input
                    {...register(`reg100_activitiesWithinProvinceExternal.0.activityDate`)}
                    type="text"
                    placeholder="เช่น 15/05/2568"
                    className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                  />
                ...
                <div>
                  ...
                  <input
                    {...register(`reg100_activitiesWithinProvinceExternal.0.evidenceLink`)}
                    type="url"
                    placeholder="https://drive.google.com/..."
                    className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                  />
            ...
            {externalFields.map((field, index) => (
              <div key={field.id} className="border border-neutral-border rounded-lg p-4 space-y-3">
                ...
                <div>
                  ...
                  <input
                    {...register(`reg100_activitiesWithinProvinceExternal.${index}.activityName`)}
                    type="text"
                    className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    {...register(`reg100_activitiesWithinProvinceExternal.${index}.activityDate`)}
                    type="text"
                    placeholder="เช่น 15/05/2568"
                    className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                  />
                ...
                <div>
                  ...
                  <input
                    {...register(`reg100_activitiesWithinProvinceExternal.${index}.evidenceLink`)}
                    type="url"
                    className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                  />
                </div>
          ...
          {outsideFields.length === 0 && (
            <div className="border border-neutral-border rounded-lg p-4 space-y-3">
              <div>
                ...
                <input
                  {...register(`reg100_activitiesOutsideProvince.0.activityName`)}
                  type="text"
                  placeholder="ชื่อกิจกรรม"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
              ...
              <div>
                ...
                <input
                  {...register(`reg100_activitiesOutsideProvince.0.activityDate`)}
                  type="text"
                  placeholder="เช่น 15/05/2568"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
              ...
              <div>
                ...
                <input
                  {...register(`reg100_activitiesOutsideProvince.0.evidenceLink`)}
                  type="url"
                  placeholder="https://drive.google.com/..."
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
          ...
          {outsideFields.map((field, index) => (
            <div key={field.id} className="border border-neutral-border rounded-lg p-4 space-y-3">
              ...
              <div>
                ...
                <input
                  {...register(`reg100_activitiesOutsideProvince.${index}.activityName`)}
                  type="text"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
              </div>
              ...
              <div>
                ...
                <input
                  {...register(`reg100_activitiesOutsideProvince.${index}.activityDate`)}
                  type="text"
                  placeholder="เช่น 15/05/2568"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
              ...
              <div>
                ...
                <input
                  {...register(`reg100_activitiesOutsideProvince.${index}.evidenceLink`)}
                  type="url"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
              </div>
