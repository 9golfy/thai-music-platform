      ...
      <div className="bg-white rounded-lg shadow-sm border border-neutral-border overflow-hidden">
        ...
        <div className="p-6 space-y-4">
          <div>
            ...
            <input
              {...register('regsup_mgtFullName')}
              type="text"
              className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
            />
            {errors.regsup_mgtFullName && (
              <p className="text-red-500 text-sm mt-1">{errors.regsup_mgtFullName.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            <input
              {...register('regsup_mgtPosition')}
              type="text"
              className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
            />
            {errors.regsup_mgtPosition && (
              <p className="text-red-500 text-sm mt-1">{errors.regsup_mgtPosition.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            <input
              {...register('regsup_mgtPhone')}
              type="tel"
              className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
            />
            {errors.regsup_mgtPhone && (
              <p className="text-red-500 text-sm mt-1">{errors.regsup_mgtPhone.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            <input
              {...register('regsup_mgtEmail')}
              type="email"
              className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
            />
            {errors.regsup_mgtEmail && (
              <p className="text-red-500 text-sm mt-1">{errors.regsup_mgtEmail.message}</p>
            )}
          </div>
