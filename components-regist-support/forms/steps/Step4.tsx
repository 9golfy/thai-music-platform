...
export default function Step4({ form, teacherImageFiles, setTeacherImageFiles, mgtImageFile }: Step4Props) {
  ...
  useEffect(() => {
    ...
    if (total > maxSize) {
      console.log(`⚠️ Total image size exceeds 10MB: ${(total / (1024 * 1024)).toFixed(2)} MB`);
      setShowSizeWarning(true);
    } else {
      // Reset warning if size is now below limit
          ...
          {fields.length === 0 && (
            <div className="border border-neutral-border rounded-lg p-4 space-y-4">
              ...
              <div>
                ...
                <select
                  {...register(`regsup_thaiMusicTeachers.0.teacherQualification`)}
              ...
              <div>
                ...
                <input
                  {...register(`regsup_thaiMusicTeachers.0.teacherFullName`)}
                  type="text"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
              </div>
              ...
              <div>
                ...
                <input
                  {...register(`regsup_thaiMusicTeachers.0.teacherPosition`)}
                  type="text"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
              </div>
              ...
              <div>
                ...
                <input
                  {...register(`regsup_thaiMusicTeachers.0.teacherEducation`)}
                  type="text"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
              </div>
              ...
              <div>
                ...
                <input
                  {...register(`regsup_thaiMusicTeachers.0.teacherPhone`)}
                  type="tel"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
              </div>
              ...
              <div>
                ...
                <input
                  {...register(`regsup_thaiMusicTeachers.0.teacherEmail`)}
                  type="email"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
              </div>
              ...
              <div>
                ...
                <input
                  id={`teacherImage-0`}
                  name={`regsup_thaiMusicTeachers.0.teacherImage`}
                  type="file"
          ...
          {fields.map((field, index) => (
            <div key={field.id} className="border border-neutral-border rounded-lg p-4 space-y-4">
              ...
              <div>
                ...
                <input
                  {...register(`regsup_thaiMusicTeachers.${index}.teacherEducation`)}
                  type="text"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                />
              </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-neutral-border overflow-hidden">
        ...
        <div className="p-6 space-y-3">
          <label className="flex items-start gap-3 cursor-pointer">
            <input
              {...register('regsup_isCompulsorySubject')}
              type="checkbox"
          ...
          <label className="flex items-start gap-3 cursor-pointer">
            <input
              {...register('regsup_hasAfterSchoolTeaching')}
              type="checkbox"
              className="mt-1 w-4 h-4 text-[#00B050] border-gray-300 rounded focus:ring-[#00B050]"
            />
          ...
          <label className="flex items-start gap-3 cursor-pointer">
            <input
              {...register('regsup_hasElectiveSubject')}
              type="checkbox"
              className="mt-1 w-4 h-4 text-[#00B050] border-gray-300 rounded focus:ring-[#00B050]"
            />
          ...
          <label className="flex items-start gap-3 cursor-pointer">
            <input
              {...register('regsup_hasLocalCurriculum')}
              type="checkbox"
              className="mt-1 w-4 h-4 text-[#00B050] border-gray-300 rounded focus:ring-[#00B050]"
            />
            ...
            <div className="border border-neutral-border rounded-lg p-4 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    {...register(`regsup_inClassInstructionDurations.0.inClassGradeLevel`)}
                    type="text"
                    className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                  />
                </div>
                <div>
                  ...
                  <input
                    {...register(`regsup_inClassInstructionDurations.0.inClassStudentCount`)}
                    type="number"
                    min="0"
