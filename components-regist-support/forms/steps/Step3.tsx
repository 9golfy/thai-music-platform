          ...
          {readinessFields.length === 0 && (
            <div className="border border-neutral-border rounded-lg p-4 space-y-3">
              <div>
                ...
                <input
                  {...register(`regsup_readinessItems.0.instrumentName`)}
                  type="text"
              ...
              <div>
                ...
                <input
                  {...register(`regsup_readinessItems.0.quantity`)}
                  type="text"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                  placeholder="จำนวน"
                />
              ...
              <div>
                ...
                <input
                  {...register(`regsup_readinessItems.0.note`)}
                  type="text"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
          ...
          {readinessFields.map((field, index) => (
            <div key={field.id} className="border border-neutral-border rounded-lg p-4 space-y-3">
              ...
              <div>
                ...
                <input
                  {...register(`regsup_readinessItems.${index}.instrumentName`)}
                  type="text"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                  placeholder="ชื่อเครื่องดนตรี"
                />
              ...
              <div>
                ...
                <input
                  {...register(`regsup_readinessItems.${index}.quantity`)}
                  type="text"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                  placeholder="จำนวน"
                />
              ...
              <div>
                ...
                <input
                  {...register(`regsup_readinessItems.${index}.note`)}
                  type="text"
                  className="w-full px-3 py-2 border border-neutral-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary/50"
                  placeholder="หมายเหตุ"
                />
