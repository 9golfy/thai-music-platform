    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-sm border border-neutral-border overflow-hidden">
        <div className="bg-primary/5 px-6 py-3 border-b border-neutral-border">
          <h3 className="font-semibold text-neutral-dark">สภาวการณ์การเรียนการสอนดนตรีไทยของสถานศึกษาในปัจจุบันเล่นดนตรีได้ 1 ชนิด</h3>
        </div>
        <div className="p-6 space-y-6">
          {fields.map((field, index) => (
            <div key={field.id} className="border border-neutral-border rounded-lg p-4 space-y-4">
              <div className="flex justify-between items-center mb-2">
                <h4 className="font-medium text-neutral-dark">ข้อมูลชุดที่ {index + 1}</h4>
                <button
                  type="button"
      ...
      <div className="bg-white rounded-lg shadow-sm border border-neutral-border overflow-hidden">
        <div className="bg-primary/5 px-6 py-3 border-b border-neutral-border">
          <h3 className="font-semibold text-neutral-dark">ความพร้อมในการส่งเสริมการเรียนการสอนดนตรีไทย ให้กับเด็กนักเรียนทุกคนในสถานศึกษา</h3>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-neutral-border overflow-hidden">
        <div className="bg-primary/5 px-6 py-3 border-b border-neutral-border">
          <h3 className="font-semibold text-neutral-dark">วิทยากร/ครูภูมิปัญญาไทย/บุคลากรภายนอก ที่ทำการสอนดนตรีไทยในปัจจุบัน</h3>
        </div>
        <div className="p-6 space-y-4">
          <p className="text-sm text-neutral-dark mb-4">
          ...
          {instructorFields.map((field, index) => (
            <div key={field.id} className="border border-neutral-border rounded-lg p-4 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-neutral-dark mb-1">ชื่อ-สกุล</label>
                  <input
                ...
                <div>
                  <label className="block text-sm font-medium text-neutral-dark mb-1">ตำแหน่ง</label>
                  <input
              ...
              <div>
                <label className="block text-sm font-medium text-neutral-dark mb-1">บทบาท/หน้าที่</label>
                <select
              ...
              <div>
                <label className="block text-sm font-medium text-neutral-dark mb-1">ที่อยู่</label>
                <input
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-neutral-dark mb-1">โทรศัพท์</label>
                  <input
                ...
                <div>
                  <label className="block text-sm font-medium text-neutral-dark mb-1">อีเมล</label>
                  <input
      ...
      <div className="bg-white rounded-lg shadow-sm border border-neutral-border overflow-hidden">
        <div className="bg-primary/5 px-6 py-3 border-b border-neutral-border">
          <h3 className="font-semibold text-neutral-dark">ระยะเวลาทำการเรียนการสอนในเวลาราชการ</h3>
        </div>
        <div className="p-6 space-y-4">
          <p className="text-sm text-neutral-dark mb-4">
          ...
          {inClassFields.map((field, index) => (
            <div key={field.id} className="border border-neutral-border rounded-lg p-4 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-neutral-dark mb-1">ระดับชั้น</label>
                  <input
                ...
                <div>
                  <label className="block text-sm font-medium text-neutral-dark mb-1">เรียนดนตรีไทยจำนวน (คน)</label>
                  <input
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-neutral-dark mb-1">ชั่วโมง/ภาคการศึกษา</label>
                  <input
                ...
                <div>
                  <label className="block text-sm font-medium text-neutral-dark mb-1">ชั่วโมง/ปีการศึกษา</label>
                  <input
      ...
      <div className="bg-white rounded-lg shadow-sm border border-neutral-border overflow-hidden">
        <div className="bg-primary/5 px-6 py-3 border-b border-neutral-border">
          <h3 className="font-semibold text-neutral-dark">ระยะเวลาทำการเรียนการสอนนอกเวลาราชการ</h3>
        </div>
        <div className="p-6 space-y-4">
          <p className="text-sm text-neutral-dark mb-4">
          ...
          {outClassFields.map((field, index) => (
            <div key={field.id} className="border border-neutral-border rounded-lg p-4 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-neutral-dark mb-1">วัน</label>
                  <select
                ...
                <div>
                  <label className="block text-sm font-medium text-neutral-dark mb-1">เวลา</label>
                  <input
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium text-neutral-dark mb-1">ถึง</label>
                  <input
                ...
                <div>
                  <label className="block text-sm font-medium text-neutral-dark mb-1">สถานที่</label>
                  <input
      ...
      <div className="bg-white rounded-lg shadow-sm border border-neutral-border overflow-hidden">
        <div className="bg-primary/5 px-6 py-3 border-b border-neutral-border">
          <h3 className="font-semibold text-neutral-dark">สถานที่ทำการเรียนการสอนในภาพรวมของสถานศึกษา </h3>
        </div>
        <div className="p-6 space-y-4">
          <div>
            <label className="block text-sm font-medium text-neutral-dark mb-1">
