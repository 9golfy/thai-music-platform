        ...
        <div className="bg-blue-50 rounded-lg p-6 shadow-lg border border-blue-200">
          ...
          <div className="bg-green-50 rounded-lg p-6 border border-green-200">
            ...
            <div className="bg-white rounded-lg p-5 mb-4 border border-gray-200">
              <h2 id="consent-title" className="text-lg font-bold text-neutral-dark mb-3">
                คำชี้แจง :
              </h2>
            ...
            <div className="flex justify-center">
              <button
                ...
                autoFocus
                className="bg-[#0FA968] hover:bg-[#0c945a] text-white font-semibold px-8 py-3 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-[#0FA968] focus:ring-offset-2"
              >
                ยอมรับ
              </button>
            </div>
