// Script to clear only school submissions and certificates (keep users and templates)
...
async function clearSchoolsOnly() {
  const client = new MongoClient(uri);

  try {
    console.log('\n⚠️  WARNING: This will DELETE school submissions and certificates!');
    console.log('Collections to be cleared:');
    console.log('  - register100_submissions');
    console.log('  - register_support_submissions');
    console.log('  - certificates');
    console.log('\nWill NOT be cleared:');
    console.log('  - certificate_templates (kept)');
    console.log('  - users (kept)');
    console.log('  - uploaded files (kept)\n');
    ...
    console.log('\n✅ School data cleared successfully!');
    console.log('\n📊 Summary:');
    ...
    console.log('💡 Next school ID will start from: SCH-YYYYMMDD-0001');
